...
$userQuery=$connection->MUpdateUser($conobj,"manager",$_SESSION["username"],$_POST['fullname'],$_POST['email'],$_POST['phone'],$_POST['password'],$_POST['dob'],$_POST['address'],$_POST['gender']);
if($userQuery==TRUE)
{
